...
export const CODEX_PROVIDER_INVARIANTS = [
  ...
  'The provider adapter preserves Codex Responses API semantics and translates provider tool calls back into Codex-compatible events.',
  'Hosted tool support must be explicit: provider-native or adapter-emulated, never silently assumed.',
...
export const CODEX_PROVIDER_NON_GOALS = [
  'Merge codex-native-api into the provider adapter.',
  'Move host-app session stores or platform adapters into the provider package.',
